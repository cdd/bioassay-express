...
public class SchemaPageTest extends PageTestBase 
{

	private static String defaultPageURL = "/diagnostics/schema.jsp";

	@BeforeEach
	public void setup()
	{	
		this.pageURL = SchemaPageTest.defaultPageURL;
		super.setup();
	}
	...
	public void testCorrectCall() throws IOException
	{
		...
		assertThat(title, is("Schema Report"));	
	}
}
