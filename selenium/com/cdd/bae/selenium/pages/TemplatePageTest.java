...
public class TemplatePageTest extends PageTestBase 
{

	private static String defaultPageURL = "/diagnostics/template.jsp";

	@BeforeEach
	public void setup()
	{	
		this.pageURL = TemplatePageTest.defaultPageURL;
		super.setup();
	}
	...
	public void testCorrectCall() throws IOException
	{
		...
		assertThat(title, is("Schema Templates"));		
	}
}
