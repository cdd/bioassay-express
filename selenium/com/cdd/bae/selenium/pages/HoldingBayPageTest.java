...
public class HoldingBayPageTest extends PageTestBase 
{

	private static String defaultPageURL = "/holding.jsp";

	@BeforeEach
	public void setup()
	{	
		this.pageURL = HoldingBayPageTest.defaultPageURL;
		super.setup();
	}
	...
	public void testCorrectCall() throws IOException
	{
		...
		assertThat(title, is("Holding Bay"));
	}
}
