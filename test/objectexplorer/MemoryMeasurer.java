 ...
 *
 * <p>
 * This class can only be used if the containing jar has been given to the Java
 * VM as an agent, as follows: {@code -javaagent:path/to/object-explorer.jar}
 *
...
public class MemoryMeasurer
{
	 ...
	 * This should be subtracted for any enum value encountered, since it is static
	 * in nature.
	 */
	...
	/**
	 * Measures the memory footprint, in bytes, of an object graph. The object graph
	 * is defined by a root object and whatever object can be reached through that,
	 ...
	 *
	 * @param rootObject
	 *          the root object that defines the object graph to be measured
	 ...
	 *          (and treated as part of the object graph), or {@code false} to
	...
	public static long measureBytes(Object rootObject, Predicate<Object> objectAcceptor)
	{
		...
		Predicate<Chain> completePredicate = Predicates.and(ImmutableList.of(new ObjectExplorer.AtMostOncePredicate(),
				ObjectExplorer.notEnumFieldsOrClasses, Predicates.compose(objectAcceptor, ObjectExplorer.chainToObject)));
