...
public abstract class Chain
{
	...
	/**
	 * Returns the value that this chain leads to. If the value is a primitive, a
	 * wrapper object is returned instead.
	 */
	...
	/**
	 * Returns whether the connection of the parent chain and this chain is through
	 * a field (of the getParent().getValue().getClass() class).
	 */
	...
	/**
	 * Returns whether the connection of the parent chain and this chain is through
	 * an array index, i.e. the parent leads to an array, and this chain leads to an
